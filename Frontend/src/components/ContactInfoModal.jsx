    ...
    >
      ...
      >
        ...
        <div className="p-4 space-y-4">
          <div>
            <h3 className="text-[#8696A0] text-xs uppercase mb-2 px-4">About</h3>
          ...
          <div>
            ...
            <button className="w-full bg-[#111B21] px-4 py-3 rounded text-left hover:bg-[#202C33] transition">
          ...
          <div className="space-y-1">
            <button className="w-full bg-[#111B21] px-4 py-3 rounded text-left hover:bg-[#202C33] transition">
              <span className="text-red-500 text-sm">Mute notifications</span>
            </button>
            <button className="w-full bg-[#111B21] px-4 py-3 rounded text-left hover:bg-[#202C33] transition">
              <span className="text-red-500 text-sm">Block</span>
            </button>
          </div>
        </div>
      </div>
